...
export const ServiceSection = () => {
  return (
    <div className="bg-overlay-3 bg-cover bg-center h-auto pt-[80px] px-5 md:px-[148px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-[76px] items-center">
          ...
          <div>
            ...
            <div className="text-center justify-center mx-auto py-2">
              <button className="font-inter font-medium text-sm md:text-base text-dark bg-[#F9D40E] w-full md:w-[298px] py-4 px-6 rounded-[24px] flex items-center justify-center gap-2 mt-2">
